...
data_cause_multiple$GroupNew <- ifelse(data_cause_multiple$Group == "cognitive" | data_cause_multiple$Group == "demographics", "other", data_cause_multiple$Group)
```
...
data_cause_both$GroupNew <- ifelse(data_cause_both$Group == "cognitive" | data_cause_both$Group == "demographics", "other", data_cause_both$Group)
...
cause_frequency <- as.data.frame(table(data_cause_multiple$GroupNew))
...
cause_both_frequency <- as.data.frame(table(data_cause_both$GroupNew))
