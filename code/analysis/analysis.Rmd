...
##analyse
rec_scale_valid_with_two_infos <- external_recurring_scale[rowSums(!is.na(external_recurring_scale[, c("validity_content","validity_construct_factor_new","validity_construct_discriminant_type","validity_construct_convergent_type","validity_criterion_type","validity_incremental")])) == 2, ] #2 + 1 from recurring within (codebook1)
rec_scale_valid_with_three_infos <- external_recurring_scale[rowSums(!is.na(external_recurring_scale[, c("validity_content","validity_construct_factor_new","validity_construct_discriminant_type","validity_construct_convergent_type","validity_criterion_type","validity_incremental")])) == 3, ] #4 + 1 from recurring within (codebook1)
...
overview_scales_firstuse$validity_content_experts[!is.na(overview_scales_firstuse$facets)] <- 1
...
overview_scales_recurring$validity_content_experts[!is.na(overview_scales_recurring$facets)] <- 1
