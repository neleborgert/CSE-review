...
overview_scales_firstuse[,4:17] <- sapply(overview_scales_firstuse[,4:17], as.numeric)
...
# replace all NA values in the data frame with 0
overview_scales_recurring[,4:17] <- sapply(overview_scales_recurring[,4:17], as.numeric)
