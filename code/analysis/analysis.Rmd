...
#only convergent
nrow(only_convergent_data)-1 #due to one empty cell
...
fancy_network
#library(htmlwidgets)
saveWidget(fancy_network, "../results/authors_network_graph.html") #save html widget
```
...
## TO DO: Theory framework variables

### TO DO: Cause variables (theory)
Frequencies: String split, long format, create data frame
```{r}
...
### TO DO: Outcome variables (theory)
...
# #save as outcome construct counts
# #library("readr")
# write_csv2(outcome_theory_data,"../results/Counts of Outcome Constructs According to Theories - Single_Study.csv")
```
