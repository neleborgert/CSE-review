...
# Save data
write.csv2(data_cause_short, "../ListOfCauseVariables.csv")
...
# Save dataframe
write.csv2(data_outcome, "../ListOfOutcomeVariables.csv")
```
...
```{r}
data_outcome <- read.csv2("../ListOfOutcomeVariables.csv")

data_cause <- read.csv2("../ListOfCauseVariables.csv")
...
ggsave("../outcome_both.png", bg = "white")
...
ggsave("../cause_both.png", bg = "white")
